...
@section('content')
	<form method="post">
		{{ csrf_field() }}
		<h3 class="heading_a">اطلاعات دستبه‌بندی آزمون</h3>
		...
		<div class="uk-grid">
			<div class="uk-width-1-7">
				...
				<a href="{{ URL::to('categories') }}"><button type="button" class="md-btn md-btn-default" style="margin-right: 10px;">انصراف</button></a>
			</div>
		</div>
	<form>
@endsection