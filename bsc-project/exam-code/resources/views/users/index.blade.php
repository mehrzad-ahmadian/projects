			...
			<table class="uk-table uk-table-nowrap table_check">
				<thead>
					<tr>
						...
						<th class="uk-width-2-10">نوع پنل</th>
				...
				<tbody>
					@foreach ($records as $record)
						<tr>
							...
							<td>{{ $record->lname }}</td>
							<td>
								@if ($record->group == 'learner')
								    محصلی
								@elseif ($record->group == 'instructor')
								    استادی
								@else
									-
								@endif
							...
							<td class="uk-text-center">
								<a href="{{ URL::to('users/edit') }}/{{ $record->id }}" class="md-btn md-btn-flat md-btn-wave waves-effect waves-button" style="padding: 0; min-width: 40px;"><i class="md-icon material-icons">&#xE254;</i></a>
